<?php
	...
	if ($HTTP_GET_VARS['flag']==3){echo "<P>Les dades de l'autor/a <B>".  changeslashbar($HTTP_GET_VARS['autor_nom'])." ". changeslashbar($HTTP_GET_VARS['autor_cognoms']). "</b> s'han editat correctament";}		
