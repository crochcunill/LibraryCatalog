<?php
	...
	if (checklenght($HTTP_POST_VARS['idioma_nom'])=="false" || checkvalues($HTTP_POST_VARS['idioma_nom'])=="false") {
			...
			$query_string="INSERT INTO idiomes (idioma_nom) VALUES ('" . $HTTP_POST_VARS['idioma_nom'] . "')";	
			...
			if (!empty($MYSQL_ERROR)){		
					...
					header("Location: ./tots_idiomes.php?validacio=".$validacio."&flag=2&idioma_nom=".$HTTP_POST_VARS['idioma_nom']); /* Redirect browser */
					exit;
				}	
