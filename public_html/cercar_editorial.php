...
if (checkvalues($editorial_nom)=="false" || checkvalues($editorial_colleccio)=="false") {
		echo "<P>Hi han caracters no valids en la combinacio <I>Nom de l'editorial/Col.lecci�</I>. Intenteu de nou";				$PerformQuery=0;						}					
...
if ($PerformQuery!=0){				
?>		
		<p>La llista d'editorials conformem al que heu entrat �s la seg�ent:
	
		<table width="100%" border="1"> 
		<TR>
			<TD width=15%><B>Nom Editorial</B></td>
			<TD width=15%><B>Col.lecci�</B></td>
			<TD width=15%><B>Adre�a</B></td>
			<TD><B>Altre informaci�</B></td>
		</TR>
