<?php
	...
	if (checklenght($_POST['autor_nom'])=="false" || $autor_nom_res[0]=="false" ||$autor_cognoms_res[0]=="false" || $autor_biografia_res[0]=="false") {
		...
		include("common_variables.php");		$query_string="INSERT INTO autors (autor_nom,autor_cognoms,autor_idioma_ID,autor_biografia) VALUES ('" . $_POST['autor_nom']. "','" . $_POST['autor_cognoms'] . "','" .$_POST['autor_idioma_ID']. "','" .$_POST['autor_biografia']. "')";	
		...
		if (!empty($mysqli_error)){		
				...
				header("Location: ./tots_autors_nom.php?validacio=".$validacio."&flag=2&autor_nom=".$_POST['autor_nom']. "&autor_cognoms=" . $_POST['autor_cognoms']."&pagina_actual=1"); /* Redirect browser */
				exit;
				}	
