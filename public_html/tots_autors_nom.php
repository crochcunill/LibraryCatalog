<?php
	...
	if ($_GET['flag']==3){echo "<P>Les dades de l'autor/a <B>".  changeslashbar($_GET['autor_nom'])." ". changeslashbar($_GET['autor_cognoms']). "</b> s'han editat correctament";}		if ($_GET['flag']==4){
		echo "<P>L'autor/a <B>".  $_GET['autor_nom']." ". $_GET['autor_cognoms']. "</b> ";
