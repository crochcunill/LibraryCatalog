...
if ($validacio!=session_id()){
		session_destroy();
		header("Location: http://./Error.php?error=1"); /* Redirect browser */
...
?>		
	...
	<FORM action="cercar_editorial.php" method=POST id=form1 name=form1>		
		<P>
		Nom Editorial:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <INPUT type="text" id=text1 name="editorial_nom">		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
