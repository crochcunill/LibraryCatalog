...
?>		
	...
	<B><?php echo changeslashbar($_POST['idioma_nom'])?></B> 
	de la llista d'idiomes?
	
	
	<FORM action="esborrar_idioma2.php" method=POST id=form1 name=form1>
	
		<INPUT type="hidden" name="idioma_nom" value="<?php echo  $_POST['idioma_nom']?>" >
		
		<INPUT type="hidden" name="validacio" value="<?php echo $validacio?>" >
		<INPUT type="hidden" name="idioma_ID" value="<?php echo $_POST['idioma_ID']?>" >
