...
if ($validacio!=session_id()){
	...
	include("common_variables.php");
		...
		$query_string="SELECT autor_ID,autor_nom,autor_cognoms,idioma_nom,autor_biografia FROM autors,idiomes WHERE autor_id=".$_POST['autor_ID']. " AND autor_idioma_ID=idioma_ID";			
